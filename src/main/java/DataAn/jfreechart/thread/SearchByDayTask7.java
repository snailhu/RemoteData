 ...
 *
 */
public class SearchByDayTask7 extends RecursiveTask<LineChartDto>{
	...
	public SearchByDayTask7(String series, String star, String paramType,
...
//			cal.set(cal.get(Calendar.YEAR), cal.get(Calendar.MONTH), cal.get(Calendar.DATE),cal.get(Calendar.HOUR_OF_DAY)+12,0);
		...
		SearchByDayDoneTask3 task = null;
		while(!forks.isEmpty()){
