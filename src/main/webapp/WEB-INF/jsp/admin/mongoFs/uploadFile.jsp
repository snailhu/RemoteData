...
//   		swal("Hello world!");
	...
	$('#submit-fileupload').click(function() {
        ...
        if(fileName.length == 0){
        	...
        	var regexp = /[a-zA-Z0-9]-0[1-9]--([0-9]{3}[1-9]|[0-9]{2}[1-9][0-9]{1}|[0-9]{1}[1-9][0-9]{2}|[1-9][0-9]{3})-(((0[13578]|1[02])-(0[1-9]|[12][0-9]|3[01]))|((0[469]|11)-(0[1-9]|[12][0-9]|30))|(02-(0[1-9]|[1][0-9]|2[0-8]))).csv/;
