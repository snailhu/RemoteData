			...
			<!--
				<li class="green"><a data-toggle="dropdown"
					...
					<ul
						...
						<li><a href="#"> <img
								src="${pageContext.request.contextPath}/static/assets/avatars/avatar.png" class="msg-photo"
						...
						<li><a href="#"> <img
								src="${pageContext.request.contextPath}/static/assets/avatars/avatar3.png" class="msg-photo"
						...
						<li><a href="#"> <img
								src="${pageContext.request.contextPath}/static/assets/avatars/avatar4.png" class="msg-photo"
			...
			<!-- 
				<li class="light-blue"><a data-toggle="dropdown" href="#"
					class="dropdown-toggle"> <img class="nav-user-photo"
						src="${pageContext.request.contextPath}/static/assets/avatars/avatar4.png" alt="Jason's Photo" /> <span
					...
					<ul
						...
						<li><a href="loginOut"> <i class="icon-off"></i> 退出
						</a></li>
					</ul>
				</li>
			-->
