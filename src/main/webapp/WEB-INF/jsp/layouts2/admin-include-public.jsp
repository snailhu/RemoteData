...
<script src="${pageContext.request.contextPath}/static/assets/js/jquery.slimscroll.min.js"></script>
<script src="${pageContext.request.contextPath}/static/assets/js/jquery.easy-pie-chart.min.js"></script>
<script src="${pageContext.request.contextPath}/static/assets/js/jquery.sparkline.min.js"></script>
<script src="${pageContext.request.contextPath}/static/assets/js/flot/jquery.flot.min.js"></script>
<script src="${pageContext.request.contextPath}/static/assets/js/flot/jquery.flot.pie.min.js"></script>
<script src="${pageContext.request.contextPath}/static/assets/js/flot/jquery.flot.resize.min.js"></script>
