$(function(){
    ...
    $('.hover-effect').mouseover(function(){        
        if($(this).is('.content-1')){
            ...
            changeColor(".content-1","../../DataRemote/static/imgs/home/20160923_13_a.png")       
        }
        else if($(this).is('.content-2')){
            block.css({'transition':'all 1s ease 0s','left':'48%'})
            changeColor(".content-2","../../../DataRemote/static/imgs/home/20160923_16.png")
        }
        else if($(this).is('.content-3')){
            block.css({'transition':'all 1s ease 0s','left':'82%'})
            changeColor(".content-3","../../DataRemote/static/imgs/home/20160923_18_a.png")
        }        
    })
    ...
    $('.hover-effect').mouseout(function(){        
        ...
        $('.content_img img').eq(0).attr("src","../../DataRemote/static/imgs/home/20160923_13.png");
        $('.content_img img').eq(1).attr("src","../../DataRemote/static/imgs/home/20160923_16_a.png");
        $('.content_img img').eq(2).attr("src","../../DataRemote/static/imgs/home/20160923_18.png");
    })

    $('.div2_content').mouseleave(function(){
        $('.content-2').find('.content_img img').attr("src","../../DataRemote/static/imgs/home/20160923_16.png");  
